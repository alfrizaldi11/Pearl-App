...
public class MenMenuCut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference2.orderByChild("group").equalTo("Men-Cut").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                treatmentAdapter = new TreatmentAdapter(MenMenuCut.this, list);
        ...
        btn_back.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                onBackPressed();
                Animatoo.animateSlideUp(MenMenuCut.this);
            }
        });
