...
public class MenMenuTreatment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(MenMenuTreatment.this)
        ...
        reference2.orderByChild("group").equalTo("Men-Treatment").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                treatmentAdapter = new TreatmentAdapter(MenMenuTreatment.this, list);
