...
public class WomenMenuHair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(WomenMenuHair.this)
        ...
        reference2.orderByChild("group").equalTo("Women-Hair").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                treatmentAdapter = new TreatmentAdapter(WomenMenuHair.this, list);
