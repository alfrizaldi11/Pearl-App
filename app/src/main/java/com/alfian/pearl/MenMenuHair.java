...
public class MenMenuHair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference2.orderByChild("group").equalTo("Men-Hair").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                treatmentAdapter = new TreatmentAdapter(MenMenuHair.this, list);
