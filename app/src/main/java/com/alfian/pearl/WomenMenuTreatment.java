...
public class WomenMenuTreatment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(WomenMenuTreatment.this)
        ...
        reference2.orderByChild("group").equalTo("Women-Treatment").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                treatmentAdapter = new TreatmentAdapter(WomenMenuTreatment.this, list);
