...
public class DetailTreatment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String detail_treatment_baru = bundle.getString("nama_treatment");


        // mengambil data dari firebase
        reference = FirebaseDatabase.getInstance().getReference().child("treatment").child("detail").child(detail_treatment_baru);
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(DetailTreatment.this)
                ...
                if (mycatatan.isEmpty()) {
                    ...
                    reference2.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            reference2.getRef().child("nama_treatment").setValue(xnama_treatment.getText().toString());
                            ...
                            Intent gotoschedule = new Intent(DetailTreatment.this, Schedule.class);
